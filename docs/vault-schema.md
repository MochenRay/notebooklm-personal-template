...
topics/
  漂移层。跨 session 聚合领域理解，可由 agent 建议、用户确认、后续重命名。
...
topic 是漂移层，不是路径真相。agent 可以建议 topic，但用户未确认前不可当成最终分类。
...
- `vault/sessions/2026/05/youtube-ai-agents-memory/` - proposed
